...
#load music
pygame.mixer.music.load('sounds/editor_music.wav')
...
save_button = Button(screen_width // 2 + 450, screen_height - 145, save_img)
load_button = Button(screen_width // 2 + 450, screen_height - 95, load_img)
...
while run:
	...
	if save_button.draw():
		#save level data
		pickle_out = open(f'level/level{level}_data', 'wb')
	...
	draw_text(f'Level: {level}', font, orange, tile_size, screen_height - 60)
